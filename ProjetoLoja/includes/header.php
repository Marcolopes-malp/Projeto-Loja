...
<head>
    ...
    <!-- CSS Principal -->
    <link rel="stylesheet" href="/ProjetoLoja/ProjetoLoja/assets/estilo.css">
...
<header class="navbar">
    ...
    <div class="container navbar-main">
        <a href="/ProjetoLoja/ProjetoLoja/index.php" class="navbar-brand">
        ...
        <form action="/ProjetoLoja/ProjetoLoja/pages/busca.php" method="GET" class="navbar-search">
        ...
        <div class="navbar-icons">
            <?php if ($is_logged_in): ?>
                <div class="dropdown" style="position: relative; display: inline-block;">
                    ...
                    <div style="margin-top: 4px; font-size: 0.85rem;">
                        <a href="/ProjetoLoja/ProjetoLoja/pages/logout.php" style="color: var(--text-secondary); text-decoration: none;">Sair da conta</a>
                    </div>
                </div>
            <?php else: ?>
                <a href="/ProjetoLoja/ProjetoLoja/pages/login.php" style="display: flex; align-items: center; gap: 6px;">
            ...
            <a href="/ProjetoLoja/ProjetoLoja/pages/favoritos.php" style="display: flex; align-items: center; gap: 6px; position: relative;">
            ...
            <a href="/ProjetoLoja/ProjetoLoja/pages/carrinho.php" style="display: flex; align-items: center; gap: 6px; position: relative;">
                <div style="position: relative;">
    ...
    <div class="navbar-bottom">
        <div class="container navbar-links">
            ...
            <a href="/ProjetoLoja/ProjetoLoja/pages/categoria.php?tipo=lacrados">Lacrados</a>
            <a href="/ProjetoLoja/ProjetoLoja/pages/categoria.php?tipo=seminovos">Seminovos</a>
            <!--<a href="#">Mac</a>
            <a href="#">iPad</a>
            <a href="#">Watch</a>
            <a href="#">Acessórios</a>-->
