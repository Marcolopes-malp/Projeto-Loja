...
<div class="container" style="padding: 60px 0; max-width: 800px; min-height: 50vh;">
    <h1 style="font-size: 2.5rem; margin-bottom: 24px;">Sobre a RFIphones</h1>
    ...
    <a href="/ProjetoLoja/ProjetoLoja/index.php" class="btn btn-outline" style="border-radius: 980px;">Ver nossos aparelhos</a>
</div>
