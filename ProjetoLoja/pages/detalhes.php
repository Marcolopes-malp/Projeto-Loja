...
<?php if ($iphone): ?>
    ...
    <div class="breadcrumb">
        ...
        <a href="/ProjetoLoja/ProjetoLoja/index.php#<?= strpos(strtolower($iphone['condicao']), 'novo') !== false ? 'lacrados' : 'seminovos' ?>">
...
<?php else: ?>
    <div style="text-align: center; padding: 100px 0;">
        ...
        <a href="/ProjetoLoja/ProjetoLoja/index.php" class="btn btn-primary">Voltar para a Página Inicial</a>
    </div>
<?php endif; ?>
