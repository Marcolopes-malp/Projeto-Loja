...
<section class="hero-slider">
    <div class="slide active-slide">
        <div class="slide-content">
            ...
            <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=lacrados" class="btn btn-outline" style="margin-top: 24px;">Comprar Agora</a>
        </div>
    </div>
    <div class="slide" style="background: linear-gradient(135deg, #1d1d1f 0%, #000 100%);">
        <div class="slide-content">
            ...
            <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=seminovos" class="btn btn-outline" style="margin-top: 24px; border-color: #f5f5f7; color: #f5f5f7;">Ver Modelos</a>
        </div>
    </div>
...
<h2 class="section-title" id="lacrados">
    ...
    <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=lacrados" class="section-link">Ver todos &rsaquo;</a>
</h2>
...
<div style="text-align: center; margin-bottom: 60px;">
    <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=lacrados" class="btn btn-outline" style="padding: 10px 40px; border-radius: 980px; text-decoration: none;">Ver mais modelos Lacrados</a>
</div>
<?php endif; ?>
...
<h2 class="section-title" id="seminovos">
    ...
    <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=seminovos" class="section-link">Ver todos &rsaquo;</a>
</h2>
<div class="products-grid" style="margin-bottom: 30px;">
...
<div style="text-align: center; margin-bottom: 60px;">
    <a href="<?= BASE_URL ?>/pages/categoria.php?tipo=seminovos" class="btn btn-outline" style="padding: 10px 40px; border-radius: 980px; text-decoration: none;">Ver mais modelos Seminovos</a>
</div>
<?php endif; ?>
    ...
    if (recentIds.length > 0) {
        ...
        recentIds.slice(0, 4).forEach(id => {
            ...
            if (prod) {
                found = true;
                grid.innerHTML += `
                    <a href="<?= BASE_URL ?>/pages/detalhes.php?id=${prod.id}" class="product-card" style="transform: scale(0.95);">
